      ...
      <AnimatePresence>
        {open && (
          <motion.div
            ...
            exit={{ x: -200 }}
            className="px-6  z-[100] py-10 bg-zinc-800 max-w-[14rem] lg:w-fit  fixed lg:relative  h-screen left-0 flex flex-col justify-between"
          >
      ...
      {navlinks.map((link: Navlink) => (
        <Link
          ...
          className={twMerge(
            ...
            isActive(link.href) && 'bg-zinc-700 shadow-lg text-white'
          )}
        >
          <link.icon
            className={twMerge(
