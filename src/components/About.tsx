    ...
    <div>
      ...
      <div className="max-w-4xl">
        ...
        <Paragraph className=" mt-4">
          ...
          particularly proud of Exterior Pro Stack and NFL Last Longer, which I
          consider to be my featured projects. These applications have been the
          focal point of my efforts and have allowed me to showcase my skills
          and dedication.
        </Paragraph>
        <Paragraph className=" mt-4">
